<?php
    ...
    $title_page = $id_article > 0 ? 'Редагування статті' : 'Додавання статті';
        ...
        <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
            ...
            <table class="edit_article">
                ...
                <tr>
                    ...
                    <td><input type="button" class="generate_url" value="Генерувати"></td>
                </tr>
                <tr>
